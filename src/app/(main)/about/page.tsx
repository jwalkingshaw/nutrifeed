    ...
    <div className="min-h-screen bg-white pt-[67px]">
      ...
      <section className="py-24 px-6 bg-[#0a0a0a]">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-medium !text-[#f7f8f8] mb-8 tracking-[-0.02em] leading-tight">
            About Stackcess
          </h1>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl sm:text-5xl font-medium text-black mb-8 tracking-[-0.02em] leading-tight">
              ...
              <div className="bg-white rounded-xl p-8 border border-gray-200">
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-medium text-black mb-2">Unified Operations</h3>
                      <p className="text-black/60 text-sm">One platform for products, compliance, and partnerships</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h3 className="font-medium text-black mb-2">Industry Focus</h3>
                      <p className="text-black/60 text-sm">Built specifically for sports supplement workflows</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h3 className="font-medium text-black mb-2">Ecosystem Growth</h3>
                      <p className="text-black/60 text-sm">Connecting all stakeholders for mutual success</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="bg-white/5 border border-white/10 backdrop-blur-sm rounded-xl p-8">
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-medium !text-[#f7f8f8] mb-2">Global Network</h3>
                      <p className="!text-[#8a8f98] text-sm">The go-to platform for supplement industry collaboration worldwide</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-2 h-2 bg-blue-400 rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h3 className="font-medium !text-[#f7f8f8] mb-2">Smart Automation</h3>
                      <p className="!text-[#8a8f98] text-sm">AI-powered workflows that eliminate manual coordination</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h3 className="font-medium !text-[#f7f8f8] mb-2">Industry Growth</h3>
                      <p className="!text-[#8a8f98] text-sm">Empowering the entire ecosystem to reach more consumers</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-4xl sm:text-5xl font-medium !text-[#f7f8f8] mb-8 tracking-[-0.02em] leading-tight">
                The future of supplements
              </h2>
              <p className="text-xl !text-[#8a8f98] leading-relaxed mb-6">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <h3 className="text-xl font-medium text-black mb-4">Industry First</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-medium text-black mb-4">Ecosystem Thinking</h3>
              <p className="text-black/60 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-medium text-black mb-4">Radical Simplicity</h3>
              <p className="text-black/60 leading-relaxed">
      ...
      <section className="py-32 px-6 bg-[#0a0a0a]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl !text-[#8a8f98] mb-8 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <span className="!text-[#8a8f98] text-sm">or</span>
            <a 
              href="mailto:hello@stackcess.com"
              className="!text-[#8a8f98] hover:!text-[#f7f8f8] text-sm font-medium transition-colors"
            >
              Get in touch
            </a>
          </div>
