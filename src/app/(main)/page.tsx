  ...
  return (
    <>
      ...
      <div className="bg-[#0a0a0a]">
        ...
        <section className="bg-[#0a0a0a] -mt-16 pt-24 pb-24 px-6">
          <div className="max-w-4xl mx-auto pt-8">
            ...
            <div className="text-4xl sm:text-5xl lg:text-6xl font-medium !text-[#f7f8f8] mb-4 tracking-[-0.02em] leading-[1.05] max-w-4xl">
              <SplitText delay={0.1}>Your supplement stack. Organized, shared, scaled.</SplitText>
            </div>
            
            {/* Clean subheadline */}
            <p className="text-lg !text-[#8a8f98] mb-12 max-w-lg leading-[1.4] font-normal">
              Connect supplement brands with retailers, distributors, and partners through one unified platform.
            </p>
            
            {/* Focused CTA */}
            <div id="hero-signup" className="mb-8 flex gap-4 items-center">
              <EmailSignup 
                source="waitlist"
                ...
                size="default"
                className="[&_form]:flex [&_form]:gap-3 [&_form]:items-start [&_input]:bg-[#0a0a0a]/5 [&_input]:border-white/10 [&_input]:!text-[#f7f8f8] [&_input]:placeholder-white/40 [&_input]:backdrop-blur-sm [&_input]:w-80 [&_input]:h-10 [&_button]:bg-[#0a0a0a] [&_button]:!text-[#f7f8f8] [&_button]:hover:bg-[#0a0a0a]/90 [&_button]:font-medium [&_button]:px-6 [&_button]:h-10 [&_button]:whitespace-nowrap [&_button]:text-sm"
              />
            </div>
        ...
        <section className="py-24 px-6 bg-[#0a0a0a]">
          <div className="max-w-5xl mx-auto text-center">
            <div className="mb-12">
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-medium !text-[#f7f8f8] mb-6 tracking-[-0.02em] leading-[1.1]">
                Scattered systems are<br />breaking your stack
              </h2>
              <div className="flex justify-center">
                <p className="text-xl !text-[#f7f8f8]/60 max-w-2xl leading-[1.4] text-center">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              <div>
                <div className="w-2 h-2 bg-red-500 rounded-full mb-6"></div>
                <h3 className="text-xl font-medium !text-[#f7f8f8] mb-4">Product Chaos</h3>
                <p className="!text-[#f7f8f8]/60 leading-[1.4]">
              ...
              <div>
                <div className="w-2 h-2 bg-red-500 rounded-full mb-6"></div>
                <h3 className="text-xl font-medium !text-[#f7f8f8] mb-4">Compliance Issues</h3>
                <p className="!text-[#f7f8f8]/60 leading-[1.4]">
              ...
              <div>
                <div className="w-2 h-2 bg-red-500 rounded-full mb-6"></div>
                <h3 className="text-xl font-medium !text-[#f7f8f8] mb-4">Launch Delays</h3>
                <p className="!text-[#f7f8f8]/60 leading-[1.4]">
        ...
        <section className="py-24 px-6 bg-[#0a0a0a]">
          <div className="max-w-5xl mx-auto text-center">
            <div className="mb-12">
              ...
              <div className="flex justify-center">
                <p className="text-xl !text-[#8a8f98] max-w-2xl leading-[1.4] text-center">
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              <div className="p-8 rounded-xl bg-[#0a0a0a]/5 border border-white/10 backdrop-blur-sm">
                <div className="w-2 h-2 bg-green-400 rounded-full mb-6"></div>
                <h3 className="text-xl font-medium !text-[#f7f8f8] mb-4">Unified Database</h3>
              ...
              <div className="p-8 rounded-xl bg-[#0a0a0a]/5 border border-white/10 backdrop-blur-sm">
                <div className="w-2 h-2 bg-blue-400 rounded-full mb-6"></div>
                <h3 className="text-xl font-medium !text-[#f7f8f8] mb-4">Automated Compliance</h3>
                <p className="!text-[#8a8f98] leading-[1.4]">
              ...
              <div className="p-8 rounded-xl bg-[#0a0a0a]/5 border border-white/10 backdrop-blur-sm">
                ...
                <h3 className="text-xl font-medium !text-[#f7f8f8] mb-4">Partner Portal</h3>
                <p className="!text-[#8a8f98] leading-[1.4]">
              ...
              <div className="p-8 rounded-xl bg-[#0a0a0a]/5 border border-white/10 backdrop-blur-sm">
                <div className="w-2 h-2 bg-purple-400 rounded-full mb-6"></div>
                <h3 className="text-xl font-medium !text-[#f7f8f8] mb-4">Launch Workflows</h3>
                <p className="!text-[#8a8f98] leading-[1.4]">
        ...
        <section className="py-24 px-6 bg-[#0a0a0a]">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-medium !text-[#f7f8f8] mb-6 tracking-[-0.02em] leading-[1.1]">
              Help us build the platform<br />your stack deserves
            </h2>
            <p className="text-xl !text-[#f7f8f8]/60 mb-8 leading-[1.4]">
            ...
            <Link 
              href="/roadmap"
              className="inline-flex items-center justify-center px-6 py-3 bg-white text-black font-medium rounded-lg hover:bg-white/90 transition-colors"
            >
        ...
        <section className="py-24 px-6 bg-[#0a0a0a]">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-start mb-12">
              ...
              <div>
                <p className="text-xl !text-[#8a8f98] mb-6 leading-[1.4]">
        ...
        <section className="py-24 px-6 bg-[#0a0a0a]">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl sm:text-5xl font-medium !text-[#f7f8f8] mb-12 tracking-[-0.02em] leading-[1.1]">
            ...
            <div className="grid md:grid-cols-3 gap-12">
              <div>
                <div className="text-6xl font-light !text-[#f7f8f8] mb-4">67%</div>
                <div className="text-lg font-medium !text-[#f7f8f8] mb-3">Faster Compliance</div>
                <p className="!text-[#f7f8f8]/60 text-sm leading-[1.4]">
                  Regulatory updates pushed instantly across all stakeholders
                </p>
              </div>
              
              <div>
                <div className="text-6xl font-light !text-[#f7f8f8] mb-4">2.3x</div>
                <div className="text-lg font-medium !text-[#f7f8f8] mb-3">Launch Velocity</div>
                <p className="!text-[#f7f8f8]/60 text-sm leading-[1.4]">
              ...
              <div>
                <div className="text-6xl font-light !text-[#f7f8f8] mb-4">89%</div>
                <div className="text-lg font-medium !text-[#f7f8f8] mb-3">Partner Satisfaction</div>
                <p className="!text-[#f7f8f8]/60 text-sm leading-[1.4]">
        ...
        <section id="final-cta" className="py-24 px-6 bg-[#0a0a0a]">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl sm:text-5xl font-medium !text-[#f7f8f8] mb-6 tracking-[-0.02em] leading-[1.1]">
              Ready to stack<br />
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
              <EmailSignup 
                ...
                size="lg"
                className="[&_input]:border-black/20 [&_input]:focus:border-black [&_button]:bg-white [&_button]:text-black [&_button]:hover:bg-white/90"
              />
              <span className="!text-[#f7f8f8]/40 text-sm">or</span>
              <Link 
                href="/roadmap"
                className="!text-[#f7f8f8]/60 hover:!text-[#f7f8f8] text-sm font-medium transition-colors"
              >
                Shape our roadmap
              </Link>
            </div>
